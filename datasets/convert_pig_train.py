      ...
      for shard_id in range(_NUM_SHARDS):
        ...
        with tf.python_io.TFRecordWriter(output_filename) as tfrecord_writer:
          ...
          for i in range(start_ndx, end_ndx):
            ...
            image_name = class_name+"_"+os.path.basename(filenames[i])

            example = dataset_utils.DA_image_to_train_tfexample(
                image_data, b'jpg', height, width, class_id, image_name, 0)
...
def run(dataset_dir):
  ...
  print('\nFinished converting the Pig dataset!')
